...
public  class CommitterX {
    ...
    @NotNull
    public final CommitterX copy(@NotNull String avatar_url, @NotNull String events_url, @NotNull String followers_url, @NotNull String following_url, @NotNull String gists_url, @NotNull String gravatar_id, @NotNull String html_url, int id, @NotNull String login, @NotNull String node_id, @NotNull String organizations_url, @NotNull String received_events_url, @NotNull String repos_url, boolean site_admin, @NotNull String starred_url, @NotNull String subscriptions_url, @NotNull String type, @NotNull String url) {
        Intrinsics.checkNotNullParameter(avatar_url, "avatar_url");
        Intrinsics.checkNotNullParameter(events_url, "events_url");
        Intrinsics.checkNotNullParameter(followers_url, "followers_url");
        Intrinsics.checkNotNullParameter(following_url, "following_url");
        ...
        Intrinsics.checkNotNullParameter(type, "type");
        Intrinsics.checkNotNullParameter(url, "url");
        return new CommitterX(avatar_url, events_url, followers_url, following_url, gists_url, gravatar_id, html_url, id, login, node_id, organizations_url, received_events_url, repos_url, site_admin, starred_url, subscriptions_url, type, url);
    }

    // $FF: synthetic method
    public static CommitterX copy$default(CommitterX var0, String var1, String var2, String var3, String var4, String var5, String var6, String var7, int var8, String var9, String var10, String var11, String var12, String var13, boolean var14, String var15, String var16, String var17, String var18, int var19, Object var20) {
        if ((var19 & 1) != 0) {
